...
export class FilterMulti extends React.Component<
  IFilterMultiProps,
  IFilterMultiState
> {
    ...
    return (
      <div
        className={`${this.props.className ? this.props.className : ""} ${
          this.props.stickyFilter ? styles.sticky : ""
        }`}
      >
        <Link
          styles={{
    ...
    const filterMulti = (
      <FilterMulti
        ...
        onApply={(() => {
          ...
          this.dispatchEvent(
            new CustomEvent(ExtensibilityConstants.EVENT_FILTER_APPLY_ALL, {
              detail: {
        ...
        onClear={(() => {
          // Bubble event through the DOM
          this.dispatchEvent(
            new CustomEvent(ExtensibilityConstants.EVENT_FILTER_CLEAR_ALL, {
              detail: {
                filterName: props.filterName,
                instanceId: props.instanceId,
              },
